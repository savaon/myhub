...
lowercareLetter1 = chr(random.randint(97,122)) #Generate a radom chr from table but lower cases (based on ASCII code)
lowercareLetter2 = chr(random.randint(97,122))
digit1 = chr(random.randint(48,57)) #random number (based on ASCII code)
